...
- All items from "Chores (Daily Default)"
...
### Today's Tasks
Pull from the sprint plan:
- Tasks relevant to today from active domain goals
- Habit items for today
- Experiment actions if applicable
- Carried items from yesterday's "What is next" (if reflect was filled)

Ask the user:
> Here's what I've pulled from your sprint plan and yesterday's reflect. Anything to add, drop,
> or adjust for today?
...
If they mention blockers, note them. If a blocker is recurring (appeared in previous dailies),
flag it: "This has come up before — is it time to address it directly?"
...
- [ ] Chore 1
- [ ] Chore 2
{day-specific chores if applicable}

## ⚙ Today
- [ ] Task 1
- [ ] Task 2
{events/reminders if applicable}
...
> **{Dayname} — wkNN** ready.
> {N} tasks, {N} chores. {event note if applicable}
>
