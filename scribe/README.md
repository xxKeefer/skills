...
Knowledge work over a corpus -- procedure capture, prose editing, and CONTEXT.md glossary curation.
...
| `/triage-notes` | Triage one fleeting inbox note: promote, taskify, or archive it on your approval |
