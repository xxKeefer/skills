...
**With a `/plan-it` output** (or invoked by `/do-it`):

- Read the step's **What** and **Done when** for the behaviour to achieve
- Use the step's **Files** to find existing test files and patterns nearby
- Translate the plan's **Acceptance Criteria** into testable behaviors
...
[ ] Test file colocated as sibling (not in separate test directories)
